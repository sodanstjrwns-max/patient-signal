/**
 * ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 *  실측근거 12·24·28-② — 질문 분류기
 * ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 *
 * ① 지역 단위 분류 (12번 · 24번)
 *    업계 실측: 동 단위 46.6%(3,177건) vs 시 단위 27.3%(22,451건) = 1.7배
 *    Gemini는 동 68.6% vs 시 22.8% = 3.0배 (GBP가 교과서라서)
 *    → "잠실 임플란트"가 "서울 임플란트"보다 1.7배 유리하다는 걸 화면에 띄워야 한다.
 *
 * ② 질문 난이도 분류 (28-② 쉬운 질문의 착시)
 *    설계 근거: "지역+시술 롱테일 질문만 잔뜩 넣고 SoV 90% 나왔다고 기뻐하면
...
/**
 * 【외국어 지역 토큰】실측근거 13(다국어) × 12번(지역 단위) 교차 지점.
 ...
 * 접미사가 없으면 상권명(DONG)으로 떨어지는데, 그러면 실측근거 12 배율표
 ...
 * 좁을수록(DONG) AI 언급률이 높다는 게 실측근거 12 결론이므로,
