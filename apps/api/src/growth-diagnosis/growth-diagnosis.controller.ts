...
export class GrowthDiagnosisController {
  ...
  @ApiOperation({
    summary: '【25번】문서당 인용 효율 — 역인과 오류 차단',
    description:
  ...
  @ApiOperation({
    summary: '【32·30번】포트폴리오 4구역 배치 + 소모/축적 수명',
  ...
  @ApiOperation({
    summary: "【20번】원장 실명 브랜딩률 ('원장' 25.8% vs 실명 0.7%)",
  ...
  @ApiOperation({
    summary: '【13번】언어별 성적표 (다국어 = 무주공산 검증)',
  ...
  @ApiOperation({
    summary: '【28-②번】질문 난이도별 SoV — 쉬운 질문의 착시 제거',
  ...
  @ApiOperation({
    summary: '【29번】부정 언급 조기경보 (비율 아닌 건수 감시 + 출처 역추적)',
