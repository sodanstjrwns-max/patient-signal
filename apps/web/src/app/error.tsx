...
export default function Error({
  ...
  return (
    <main className="min-h-screen flex flex-col items-center justify-center gap-6 p-6 bg-[#f4f4f8] text-[#111118]">
      <div className="text-[clamp(6rem,18vw,12rem)] font-medium leading-none tracking-[-0.09em] text-[#5b4dff]">Oops.</div>
      ...
      <div className="flex gap-3">
        ...
        <a
          href="/dashboard"
          className="px-6 py-2.5 border border-[#dedee8] bg-white rounded-none text-[#111118] hover:bg-[#ededf6] flex items-center gap-2"
        >
