  ...
  if (status === 'loading') {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center gap-4">
        ...
        <p className="text-[#606070] text-lg">카드를 등록하고 있습니다...</p>
      </div>
    );
  }
  ...
  if (status === 'error') {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center gap-4 p-6">
        ...
        <h2 className="text-2xl font-bold text-[#111118]">카드 등록에 문제가 있습니다</h2>
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center gap-6 p-6">
      ...
      <div className="text-center">
        <h2 className="text-3xl font-bold text-[#111118] mb-2">카드 등록 완료!</h2>
      ...
      <a
        href="/dashboard"
        className="px-8 py-3 bg-brand-600 text-white rounded-md font-bold hover:bg-brand-700 flex items-center gap-2"
      >
