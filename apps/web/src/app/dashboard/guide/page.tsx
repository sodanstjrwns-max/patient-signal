    ...
    <div className="min-h-screen bg-[#f1f1eb]">
      ...
      <main className="mx-auto max-w-[1440px] space-y-7 px-5 py-7 sm:px-8 xl:px-10">
          ...
          <Card className="border-[#d4d6cb] bg-[#f1f1eb]">
            <CardContent className="pt-6">
              <div className="flex items-start gap-4">
                <div className="p-3 rounded-md bg-[#e9ebe1] text-[#44551d] shrink-0">
                  <BookOpen className="w-6 h-6" />
                </div>
                <div>
                  <h2 className="text-lg font-semibold text-[#141512] mb-2">
                    Patient Signal은 &quot;AI 검색 시대의 건강검진&quot;입니다
                  </h2>
                  <p className="text-sm text-[#687253] leading-relaxed">
                    ...
                    <strong className="text-[#141512]"> 우리 병원이 등판하는지 · 몇 번째로 불리는지 · 어떤 톤으로 소개되는지</strong>를
            ...
            <CardHeader>
              <CardTitle className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <span className="block text-[11px] font-semibold text-[#909781] mt-0.5">
              ...
              {[
                ...
                >
                  ...
                  <div className="min-w-0">
                    <h3 className="text-sm font-semibold text-[#141512]">{item.title}</h3>
                    <p className="text-xs text-[#72756a] leading-relaxed mt-1">{item.desc}</p>
        ...
        <section id="core-terms-section">
          <h2 className="text-xl font-semibold text-[#141512] mb-1">1. 숫자 읽는 법 — 핵심 4총사</h2>
          <p className="text-sm text-[#72756a] mb-4">이 네 가지만 구분하면 대시보드의 80%가 읽힙니다.</p>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {CORE_TERMS.map((t) => (
              <Card key={t.name} className="hover:border-[#d4d6cb] transition-shadow">
                <CardHeader className="pb-2">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <span className="text-xs font-bold text-[#909781]">한 줄 요약: &quot;{t.oneLiner}&quot;</span>
                    </div>
                  </div>
                </CardHeader>
                <CardContent className="space-y-2">
                  <p className="text-sm text-[#687253] leading-relaxed">{t.desc}</p>
                  <div className="flex items-start gap-2 text-xs bg-[#f1f1eb] rounded-lg p-2.5 text-[#72756a]">
          ...
          {/* 30초 요약 박스 */}
          <div className="mt-4 rounded-md border-2 border-dashed border-[#d4d6cb] bg-[#f1f1eb]/50 p-4">
            <p className="text-sm font-bold text-[#141512]">
              💡 30초 요약: <span className="font-medium text-[#141512]">
        ...
        <section id="advanced-terms-section">
          <h2 className="text-xl font-semibold text-[#141512] mb-1">2. 리포트에 나오는 심화 용어</h2>
          <p className="text-sm text-[#72756a] mb-4">ABHS 리포트·인사이트 페이지에서 만나는 개념들. 각 지표 옆 ⓘ 아이콘에서도 같은 설명을 볼 수 있습니다.</p>
          <Card>
            <CardContent className="pt-6 divide-y divide-slate-100">
              {ADVANCED_TERMS.map((t) => (
                <div key={t.name} className="py-3 first:pt-0 last:pb-0">
                  <h3 className="text-sm font-bold text-[#141512] mb-1">{t.name}</h3>
                  <p className="text-sm text-[#687253] leading-relaxed">{t.desc}</p>
                </div>
              ))}
            </CardContent>
        ...
        <section id="menu-guide-section">
          <h2 className="text-xl font-semibold text-[#141512] mb-1">3. 메뉴별 안내 — 어디서 뭘 보나</h2>
          <p className="text-sm text-[#72756a] mb-4">각 카드를 누르면 해당 메뉴로 이동합니다.</p>
          <div className="space-y-6">
            {MENU_GUIDE.map((group) => (
              <div key={group.group}>
                <h3 className="text-xs font-semibold text-[#909781] uppercase tracking-wider mb-2">{group.group}</h3>
                      ...
                      <Card className="h-full hover:border-brand-200 transition-colors">
                        <CardContent className="pt-4 pb-4">
                          <div className="flex items-center gap-2 mb-2">
                            <item.icon className="w-4 h-4 text-[#44551d]" />
                            <span className="font-bold text-sm text-[#141512] group-hover:text-[#44551d] transition-colors">{item.name}</span>
                          </div>
                          <p className="text-xs text-[#687253] leading-relaxed mb-2">{item.what}</p>
        ...
        <section id="calendar-guide-section">
          <h2 className="text-xl font-semibold text-[#141512] mb-1">4. 56주 캘린더 — 이렇게 쓰세요</h2>
          <p className="text-sm text-[#72756a] mb-4">1년치 콘텐츠 계획을 대신 짜주는 기능입니다.</p>
          <Card>
              ...
              <ol className="space-y-3">
                {[
                  ...
                  <li key={s.step} className="flex gap-3">
                    <span className="w-6 h-6 rounded-full bg-[#d0ff43] text-white text-xs font-semibold flex items-center justify-center shrink-0 mt-0.5">{s.step}</span>
                    <div>
                      <p className="text-sm font-bold text-[#141512]">{s.title}</p>
                      <p className="text-sm text-[#687253] leading-relaxed">{s.desc}</p>
                    </div>
                  </li>
                ))}
              </ol>
        ...
        <section id="routine-section">
          <h2 className="text-xl font-semibold text-[#141512] mb-1">5. 추천 주간 루틴 — 주 37분이면 충분합니다</h2>
          <p className="text-sm text-[#72756a] mb-4">매일 다 볼 필요 없습니다. 이 루틴대로만 보세요.</p>
          <Card>
            <CardContent className="pt-6">
              <div className="space-y-3">
                {WEEKLY_ROUTINE.map((r) => (
                  <div key={r.day} className="flex items-start gap-3">
                    ...
                    <div>
                      <span className="text-sm font-bold text-[#141512]">{r.day}</span>
                      <p className="text-sm text-[#687253] leading-relaxed">{r.task}</p>
                    </div>
                  </div>
                ))}
              </div>
        ...
        <section id="closing-section" className="pb-8">
          <div className="rounded-lg border border-brand-100 bg-brand-50 p-6 text-center">
            <p className="text-sm font-medium text-[#687253] leading-relaxed">
