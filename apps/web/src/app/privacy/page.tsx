  ...
  return (
    <div className="min-h-screen bg-[#08090a] flex flex-col text-[#f5f5ef]">
      ...
      <main className="flex-1 max-w-5xl mx-auto px-5 sm:px-8 py-12 sm:py-16 w-full">
        ...
        <h1 className="font-display text-4xl sm:text-5xl font-semibold tracking-[-0.06em] text-[#f5f5ef] mb-3">
          페이션트 시그널 개인정보처리방침
        </h1>
        ...
        <div className="border-t border-[#30343a] bg-[#111315] p-6 sm:p-9 divide-y divide-[#30343a] [&>section]:py-7 [&>section:first-child]:pt-0 [&>section:last-child]:pb-0">
          ...
          <section>
            <h2 className="font-display text-xl font-semibold text-[#f5f5ef] mb-4">2. 개인정보의 처리 목적</h2>
            <ul className="list-disc list-inside text-[#959c9f] space-y-2">
          ...
          <section>
            <h2 className="font-display text-xl font-semibold text-[#f5f5ef] mb-4">3. 보유 및 이용 기간</h2>
            <p className="text-[#959c9f] mb-3">
              회원 탈퇴 시 지체 없이 파기합니다. 단, 관련 법령에 따라 다음 기간 보관합니다:
            </p>
            <ul className="list-disc list-inside text-[#959c9f] space-y-1">
          ...
          <section>
            <h2 className="font-display text-xl font-semibold text-[#f5f5ef] mb-4">4. 개인정보의 처리 위탁</h2>
            <div className="overflow-x-auto">
              <table className="min-w-full border border-[#30343a] rounded-lg">
                <thead className="bg-[#08090a]">
                  <tr>
                    <th className="px-4 py-2 text-left text-sm font-medium text-[#c0c4c7] border-b">
                      수탁자
                    </th>
                    <th className="px-4 py-2 text-left text-sm font-medium text-[#c0c4c7] border-b">
                      위탁 업무
          ...
          <section>
            <h2 className="font-display text-xl font-semibold text-[#f5f5ef] mb-4">5. 정보주체의 권리</h2>
            <p className="text-[#959c9f] leading-relaxed">
          ...
          <section>
            <h2 className="font-display text-xl font-semibold text-[#f5f5ef] mb-4">6. 개인정보의 파기</h2>
            <p className="text-[#959c9f] leading-relaxed">
          ...
          <section>
            <h2 className="font-display text-xl font-semibold text-[#f5f5ef] mb-4">7. 안전성 확보 조치</h2>
            <p className="text-[#959c9f] leading-relaxed">
          ...
          <section>
            <h2 className="font-display text-xl font-semibold text-[#f5f5ef] mb-4">8. 개인정보 보호책임자</h2>
            <div className="text-[#959c9f] bg-[#08090a] rounded-sm p-4">
              <p>성명: 문석준 (대표)</p>
              <p>이메일: patientsfunnel@gmail.com</p>
              <p>연락처: 010-4445-1873</p>
            </div>
            <p className="text-[#959c9f] mt-4">
          ...
          <section>
            ...
            <p className="text-[#959c9f]">이 방침은 2026년 8월 20일부터 적용됩니다.</p>
          </section>
        </div>
