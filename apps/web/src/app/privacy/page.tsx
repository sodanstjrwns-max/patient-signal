    ...
    <div className="min-h-screen bg-mesh">
      <div className="max-w-4xl mx-auto px-4 py-16">
        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-sm p-8 space-y-8">
          ...
          <section>
            <h2 className="text-xl font-semibold text-slate-800 mb-4">1. 수집하는 개인정보 항목</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-slate-800 mb-4">2. 개인정보의 수집 및 이용 목적</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-slate-800 mb-4">3. 개인정보의 보유 및 이용 기간</h2>
            <div className="text-slate-600 space-y-3">
          ...
          <section>
            <h2 className="text-xl font-semibold text-slate-800 mb-4">4. 개인정보의 제3자 제공</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-slate-800 mb-4">5. 개인정보 처리 위탁</h2>
              ...
              <div className="overflow-x-auto">
                <table className="min-w-full border border-slate-200 rounded-lg">
                  <thead className="bg-mesh">
                    <tr>
                      <th className="px-4 py-2 text-left text-sm font-medium text-slate-700 border-b">위탁받는 자</th>
                      <th className="px-4 py-2 text-left text-sm font-medium text-slate-700 border-b">위탁 업무</th>
                    </tr>
                  </thead>
                  <tbody>
                    <tr>
          ...
          <section>
            <h2 className="text-xl font-semibold text-slate-800 mb-4">6. 이용자의 권리와 행사 방법</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-slate-800 mb-4">7. 개인정보 보호를 위한 기술적/관리적 대책</h2>
            <ul className="list-disc list-inside text-slate-600 space-y-2">
          ...
          <section>
            <h2 className="text-xl font-semibold text-slate-800 mb-4">8. 쿠키(Cookie)의 사용</h2>
            <div className="text-slate-600 space-y-3">
          ...
          <section>
            <h2 className="text-xl font-semibold text-slate-800 mb-4">9. 개인정보 보호책임자</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-slate-800 mb-4">10. 개인정보처리방침 변경</h2>
            <p className="text-slate-600 leading-relaxed">
